...
// $mail->addAddress('affleads55@gmail.com');
    ...
    $mail->Subject = 'Заявка с сайта Metacrete Многостраничник('.$forma.')'; // тема письма
    $mail->isHTML(true);
    ...
    $message .= '<tr><td>Страница захвата:</td><td> https://'.$host.'/site</td></tr>';
    $amo_message .='Страница захвата: https://'.$host.'/site'.PHP_EOL;
